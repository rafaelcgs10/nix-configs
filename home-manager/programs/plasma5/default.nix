...
in
{
  ...
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to English (intl., with AltGr dead keys)" =  "Meta+Shift+U" ;
    ...
    files = {
      ...
      "kcminputrc"."Libinput.2.14.ETPS/2 Elantech TrackPoint"."PointerAcceleration" = 0.000000;
      ...
      "kxkbrc"."Layout"."VariantList" = "thinkpad,altgr-intl";
