...
in
{
  ...
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "Alacritty.desktop"."_launch" = ["Ctrl+Alt+T" "Meta+Return"];
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to English (US, intl., with dead keys)" = "Meta+Shift+U";
      "KDE Keyboard Layout Switcher"."Switch keyboard layout to Portuguese (Brazil, IBM/Lenovo ThinkPad)" = "Meta+Shift+B";
      ...
      "ksmserver"."Lock Session" = ["Meta+O" "Screensaver"];
      ...
      "kwin"."Window Pack Up" = [ ];
      "kwin"."Window Quick Tile Bottom" = ["Meta+Down" "Meta+Shift+J"];
      "kwin"."Window Quick Tile Bottom Left" = [ ];
      "kwin"."Window Quick Tile Bottom Right" = [ ];
      "kwin"."Window Quick Tile Left" = ["Meta+Left" "Meta+Shift+H"];
      "kwin"."Window Quick Tile Right" = ["Meta+Right" "Meta+Shift+L"];
      "kwin"."Window Quick Tile Top" = ["Meta+Up" "Meta+Shift+K"];
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."2a8a7b0f-2101-425e-b494-39f585de8194" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "2a8a7b0f-2101-425e-b494-39f585de8194";
      "kcminputrc"."Libinput.2.14.ETPS/2 Elantech TrackPoint"."PointerAcceleration" = "-0.200";
      "kcminputrc"."Libinput.2.14.ETPS/2 Elantech TrackPoint"."PointerAccelerationProfile" = 1;
      "kcminputrc"."Libinput.2.14.ETPS/2 Elantech TrackPoint"."ScrollFactor" = 1;
      "kcminputrc"."Libinput.6127.24745.Primax Lenovo Essential Wireless Keyboard and Mouse Combo"."PointerAcceleration" = "-0.600";
      "kcminputrc"."Libinput.6127.24745.Primax Lenovo Essential Wireless Keyboard and Mouse Combo"."PointerAccelerationProfile" = 1;
      "kcminputrc"."Libinput.7847.102.2.4G Mouse"."PointerAcceleration" = "-0.400";
      "kcminputrc"."Libinput.7847.102.2.4G Mouse"."PointerAccelerationProfile" = 1;
      ...
      "kglobalshortcutsrc"."KDE Keyboard Layout Switcher"."_k_friendly_name" = "KWin";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{43effb86-3303-4fdd-8168-7416c47f8a22}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{f6c1d7eb-5e01-4707-960b-8f5eb6057267}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{414bcc50-9d8a-4a6e-894a-8a2308490a81}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{3258c629-d4e0-4565-ace0-03809c12220b}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{73e1d550-29bc-4947-8abf-ffbe699a2f92}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{c1564335-eacf-43f9-ae10-84a09790a48d}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{963b6fd9-049c-4022-b75c-ec36dfb333d3}";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/nix/store/4bcqsgihsd8bjqk27abg6c94y1vwa63n-plasma-workspace-wallpapers-5.26.5/share/wallpapers/Honeywave/";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/nix/store/4bcqsgihsd8bjqk27abg6c94y1vwa63n-plasma-workspace-wallpapers-5.26.5/share/wallpapers/Honeywave/";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."SlidePaths" = "/home/rafael/.local/share/wallpapers/,/nix/store/7dwfc6n7lb5mic0ql3ama8g7baal6bq5-breeze-qt5-5.26.5-bin/share/wallpapers/,/run/current-system/sw/share/wallpapers/";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.potd.General"."FillMode" = 2;
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.potd.General"."Provider" = "flickr";
      ...
      "kwinrc"."Desktops"."Id_1" = "af60e41f-aa0e-4d76-a070-8ed8313a104e";
      "kwinrc"."Desktops"."Id_10" = "e0466238-2027-406e-821b-9e6176501645";
      "kwinrc"."Desktops"."Id_2" = "c4baeaf1-20e9-45f1-ac5d-ba16b15a9623";
      "kwinrc"."Desktops"."Id_3" = "b0c43185-11ea-4dee-9a65-50fb3e2a2e45";
      "kwinrc"."Desktops"."Id_4" = "518a3791-312e-48e2-9cc7-98196c1f99c3";
      "kwinrc"."Desktops"."Id_5" = "c41c2621-d03c-4e29-bf4a-13b873fc608f";
      "kwinrc"."Desktops"."Id_6" = "a8182b5c-e40d-4381-b7c3-1e306983cba3";
      "kwinrc"."Desktops"."Id_7" = "bd0784bf-bd4d-481e-8234-90d5cc9dbd9a";
      "kwinrc"."Desktops"."Id_8" = "3af93fab-2199-4f0c-850f-41c9578b7e68";
      "kwinrc"."Desktops"."Id_9" = "f77225c0-0cbf-4e16-a709-4bb7ce2ea3b0";
      "kwinrc"."Desktops"."Name_10" = "Desktop 11";
      "kwinrc"."Desktops"."Name_8" = "Desktop 9";
      "kwinrc"."Desktops"."Name_9" = "Desktop 10";
      "kwinrc"."Desktops"."Number" = 10;
      "kwinrc"."Desktops"."Rows" = 2;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."LatitudeAuto" = 55.6689;
      "kwinrc"."NightColor"."LongitudeAuto" = 12.5872;
      ...
      "kwinrc"."Tiling.5d7042a3-7d53-5501-b020-3965109ba18f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Windows"."RollOverDesktops" = true;
      "kxkbrc"."Layout"."DisplayNames" = ",";
      "kxkbrc"."Layout"."LayoutList" = "br,us";
      "kxkbrc"."Layout"."Use" = true;
      "kxkbrc"."Layout"."VariantList" = "thinkpad,intl";
